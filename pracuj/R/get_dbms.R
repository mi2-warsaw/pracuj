...
#'
#' @usage get_dbms(type = c("all", "Content store", "Document store",
#' "Event Store", "Graph DBMS", "Key-value store", "Multivalue DBMS",
#' "Native XML DBMS", "Navigational DBMS", "Object oriented DBMS", "RDF store",
#' "Relational DBMS", "Search engine", "Time Series DBMS", "Wide column store"))
#'
