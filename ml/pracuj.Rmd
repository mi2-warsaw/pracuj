...
One can observe that performances are almost identical for each database grouping and that always the best option (by a bit) was keeping all databases in their separate columns.
